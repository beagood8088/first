...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.first.FirstApplicationTests", () -> new AotSpringBootConfigContextLoader(FirstApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.first.FirstApplicationTests", FirstApplicationTestsContextInitializer.class);
    return entries;
  }
}
